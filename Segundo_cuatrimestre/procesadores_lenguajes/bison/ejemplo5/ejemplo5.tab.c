...
#line 130 "ejemplo5.tab.c" /* yacc.c:355  */
};
...
#line 145 "ejemplo5.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "FIN", "PRINT", "NUMBER", "VAR",
  "INDEFINIDA", "FUNCION_PREDEFINIDA", "ASIGNACION", "'+'", "'-'", "'*'",
  "'/'", "'%'", "UNARIO", "'^'", "'('", "')'", "$accept", "list", "asgn",
  "expr", YY_NULLPTR
};
#endif
...
{
     -13,    57,   -13,     0,   -13,    20,    -5,     3,   -13,   -13,
      -5,    -9,    20,    20,    20,   -13,     8,    20,   -13,    20,
      -7,    -7,    22,   -13,    20,    20,    20,    20,    20,    20,
      40,    31,   -13,    52,    52,    -7,    -7,    -7,    -7,   -13
};
...
{
       2,     0,     1,     0,     3,     0,     0,     0,     6,     8,
       9,     0,     0,     0,     0,    10,     0,     0,     4,     0,
      20,    19,     0,     5,     0,     0,     0,     0,     0,     0,
       7,     0,    18,    12,    13,    14,    15,    16,    17,    11
};
...
{
      20,    21,    22,     8,    17,    30,    18,    31,    19,    29,
       7,    23,    33,    34,    35,    36,    37,    38,    24,    25,
      26,    27,    28,     0,    29,     9,    10,     0,    11,     0,
      12,    13,    24,    25,    26,    27,    28,    14,    29,     0,
      32,    24,    25,    26,    27,    28,     0,    29,     0,    39,
      24,    25,    26,    27,    28,     0,    29,     2,     3,     0,
       4,     5,     0,     6,    26,    27,    28,     0,    29
};

static const yytype_int8 yycheck[] =
{
      12,    13,    14,     3,     9,    17,     3,    19,    17,    16,
       1,     3,    24,    25,    26,    27,    28,    29,    10,    11,
      12,    13,    14,    -1,    16,     5,     6,    -1,     8,    -1,
      10,    11,    10,    11,    12,    13,    14,    17,    16,    -1,
      18,    10,    11,    12,    13,    14,    -1,    16,    -1,    18,
      10,    11,    12,    13,    14,    -1,    16,     0,     1,    -1,
       3,     4,    -1,     6,    12,    13,    14,    -1,    16
};
...
{
       0,    20,     0,     1,     3,     4,     6,    21,     3,     5,
       6,     8,    10,    11,    17,    21,    22,     9,     3,    17,
      22,    22,    22,     3,    10,    11,    12,    13,    14,    16,
      22,    22,    18,    22,    22,    22,    22,    22,    22,    18
};
